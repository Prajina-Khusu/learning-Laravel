...
<html lang="en">
  ...
  <section class="my-5">
      <div class="py=5">
          <h2 class="text-center" style="color:	#198754;">Register Now  </h2>
      </div>
    ...
    <div class="mb-3 mt-3">
      ...
      <center><button type="submit" class="btn btn-success">Register</button><p>Already have an account ? <a href='login'>Login</a></p></center>
